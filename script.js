...
async function searchShows(query) {
    ...
    displayMessage('<p>Buscando series...</p>', null, resultsContainer); // Show loading message
    ...
    try {
        ...
        const data = await response.json();
        displayResults(data.results, resultsContainer, IMAGE_BASE_URL_POSTER);
    } catch (error) {
        console.error("Error fetching data:", error);
        displayMessage("Ocurrió un error al buscar las series. Inténtalo de nuevo.", 'red', resultsContainer);
    }
}
